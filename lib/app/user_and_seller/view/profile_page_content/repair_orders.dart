...
class _RepairOrdersState extends State<RepairOrders> {
  ...
  List<String> itemlist2 = ["10 PM - 12 PM", "12 PM - 2 PM", "2 PM - 4 PM", "4 PM - 6 PM", "6 PM - 8 PM"];
                          ...
                          itemBuilder: (_, index) {
                            ...
                            return Column(children: <Widget>[
                              ...
                              Row(
                                ...
                                children: [
                                  if (appointments.serviceman_status == "1" && appointments.repairTime.isEmpty)
                                    MaterialButton(
                                      color: AppColor.primary,
                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                                      onPressed: () async {
                                        await UserAuthController.completeRepairOrder(repair_id: appointments.id).then((value) {
                                          // setState(() {});
                                    ...
                                    MaterialButton(
                                      ...
                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                                      onPressed: () async {
                                        await UserAuthController.acceptRepairOrder(repair_id: appointments.id).then((value) {
                                          // setState(() {});
                                          if (value != null) {
                                            ScaffoldMessenger.of(context).showSnackBar(
                                              SnackBar(
                                  ...
                                  MaterialButton(
                                    color: AppColor.primary,
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                                    onPressed: () => showMessageDialog(context, from: email, to: appointments.seller),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: buildInputDecoration(Icons.phone, "Date (DD-MM-YYYY)"),
