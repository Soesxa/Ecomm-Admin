...
class _RepairRequestAcceptState extends State<RepairRequestAccept> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: buildInputDecoration(Icons.person, "Service Man Name"),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: phone1,
                        keyboardType: TextInputType.text,
                        decoration: buildInputDecoration(Icons.phone, "Mechanic Phone"),
                        validator: (String? value) {
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (_formkey.currentState!.validate()) {
                            confirmAppointment(user, seller, service, rid, address, issue, date, time, context);
                            return;
                          }
                        },
                    ...
                    Expanded(
                      child: FutureBuilder(
                          future: UserController.fetchServiceProviderWthNumber(phone1.text),
                                ...
                                child: snapshot.data.length > 0
                                    ...
                                    : Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: CommonController.primaryTitleBlack.copyWith(color: Colors.grey, fontSize: 16),
                                        ),
                                      ),
                              );
                            } else {
  ...
  Future confirmAppointment(String user, String seller, String service, String rid, String address, String issue, String date, String time, BuildContext context) async {
    var postData = {'user': user, 'date': date, 'time': time, 'seller': seller, 'service': service, 'address': address, 'issue': issue, 'rid': rid, 'phone': phone1.text};
