                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return Padding(
                            ...
                            child: StaggeredCardCard2(email, begin: Colors.purple, end: Colors.purple, categoryName: sellerItem.shopName, assetPath: 'assets/icons/shop.png', sellerId: sellerItem.id),
                          );
                        });
                  }
